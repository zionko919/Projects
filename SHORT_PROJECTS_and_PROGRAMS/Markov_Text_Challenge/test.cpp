...
BOOST_AUTO_TEST_CASE(order1) {
        ...
        BOOST_REQUIRE_NO_THROW(mm.kRand("g"));

        BOOST_REQUIRE_THROW(mm.kRand("x"), std::runtime_error);

        BOOST_REQUIRE_THROW(mm.kRand("xx"), std::runtime_error);
}
